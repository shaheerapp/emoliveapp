...
export default function Search({ navigation }: any) {
  ...
  const isAgencyOwner = user.roles?.some(
    (role: any) => role.name.trim().toLowerCase() === 'agency owner',
  );

  const filteredActionItems = isAgencyOwner
    ? actionItems.filter(item => item.title !== 'Apply for Agency')
    : actionItems;
  ...
  const renderItem = ({ item }: any) => (
    <TouchableOpacity
      ...
      onPress={() => {
        ...
        } else if (item.navigation && item.title !== 'Terms') {
            ...
            <>
              ...
              >
                <View style={styles.imageContainer}>
                  <View style={styles.avatarWrapper}>
                    {user?.active_frame && (
                      <LottieView
                        source={{
                          uri: envVar.IMAGES_URL + user.active_frame.image,
                ...
                <View style={styles.userInfo}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    >
                      {user.country ? user.country : 'Please Provide'}
                    </Text>
                    <Image
                ...
                >
                  ...
                  <View style={[styles.checkVip]}>
                    ...
                    <View
                      style={{ position: 'absolute', right: -1.5, top: -2 }}
                    >
                      <Image
              ...
              >
                <View style={styles.gradientView}>
                  <Text style={[appStyles.paragraph1, styles.topgradientItem]}>
                    {formatNumber(user?.wallet?.diamonds || 0)}
                  </Text>
                  <Text style={[appStyles.headline2, styles.topgradientItem]}>
                    Diamonds
                  </Text>
                ...
                <View style={styles.gradientView}>
                  <Text style={[appStyles.paragraph1, styles.topgradientItem]}>
                    {formatNumber(user?.wallet?.beans || 0)}
                  </Text>
                  <Text style={[appStyles.headline2, styles.topgradientItem]}>
                    Beans
                  </Text>
              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() => {
                    navigation.navigate('TopUpAgent');
                  }}
                >
                  <Image
              ...
              >
                ...
                />
                <Text
                  style={[appStyles.title1, { color: colors.complimentary }]}
                >
                  Others
                </Text>
                <FlatList
